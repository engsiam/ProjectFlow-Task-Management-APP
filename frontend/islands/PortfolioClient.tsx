...
import { EmptyState, Icon, Skeleton } from "../components/ui.tsx";
  ...
  return (
    <div class="pf-container">
      ...
      <div class="pf-hero">
        <div class="pf-hero-main">
            ...
            <div class="pf-hero-ring">
              <svg width="96" height="96" viewBox="0 0 96 96">
                ...
                <circle
                  ...
                  strokeDashoffset={`${
                    2 * Math.PI * 40 * (1 - exec.healthScore / 100)
                  }`}
                  strokeLinecap="round"
              ...
              <span class="pf-hero-ring-value" style={`color:${scoreColor}`}>
                {exec.healthScore}
              </span>
            </div>
            <div class="pf-hero-meta">
              <div class="pf-hero-label">Portfolio Health</div>
              <div class="pf-hero-status" style={`color:${scoreColor}`}>
                {riskLabel(
                  exec.healthScore >= 70
                    ? "ON_TRACK"
                    : exec.healthScore >= 40
              ...
              <div class="pf-hero-trend">
                <Icon
                  name={exec.weeklyTrendDirection === "up"
                    ? "trending_up"
                    : exec.weeklyTrendDirection === "down"
                    ? "trending_down"
                    : "trending_flat"}
                  size={14}
                />
          ...
          <div class="pf-hero-stats">
            ...
            <div class="pf-hero-stat">
              <div class="pf-hero-stat-value" style="color:#10b981">
                {exec.healthyCount}
              </div>
              <div class="pf-hero-stat-label">On Track</div>
            </div>
            <div class="pf-hero-stat">
              <div class="pf-hero-stat-value" style="color:#f59e0b">
                {exec.atRiskCount}
              </div>
              <div class="pf-hero-stat-label">At Risk</div>
            </div>
            <div class="pf-hero-stat">
              <div class="pf-hero-stat-value" style="color:#ef4444">
                {exec.criticalCount}
              </div>
        ...
        {data.forecast && (
          <div class="pf-hero-forecast">
            <div class="pf-hero-forecast-item">
              ...
              <span class="pf-hero-forecast-value">
                {fmtDate(data.forecast.predictedCompletionDate)}
              </span>
            </div>
            <div class="pf-hero-forecast-item">
              <span class="pf-hero-forecast-label">On-Time Probability</span>
              <span
                class="pf-hero-forecast-value"
                style={`color:${riskColor(data.forecast.riskLevel)}`}
              >
                {fmtPct(data.forecast.onTimeProbability)}
              </span>
            </div>
            <div class="pf-hero-forecast-item">
              ...
              <span
                class="pf-hero-forecast-value"
                style={`color:${
                  data.team?.teamEfficiency >= 70
                    ? "#10b981"
                    : data.team?.teamEfficiency >= 40
                    ? "#f59e0b"
                    : "#ef4444"
                }`}
              >
                {data.team?.teamEfficiency ?? "—"}%
              </span>
            </div>
          </div>
        )}
      ...
      {data.matrix && data.matrix.length > 0 && (
        <div class="pf-section">
          <h3 class="pf-section-title">
            <Icon name="gpp_bad" size={18} /> Risk Matrix
          </h3>
                ...
                {data.matrix.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td class="pf-rm-score" style={`color:${clr}`}>
                        {item.healthScore}
                      </td>
                      <td style={`color:${clr}`}>
                      ...
                      <td>
                        <div class="pf-rm-bar">
                          <div
                            class="pf-rm-bar-fill"
                            style={`width:${item.completionPct}%;background:${clr}`}
                          />
                          <span class="pf-rm-bar-label">
                            {item.completionPct}%
                          </span>
                        </div>
                      </td>
                      ...
                      >
                        {item.deadlineStatus === "OVERDUE"
                          ...
                          : item.deadlineStatus === "AT_RISK"
                          ? "AT RISK"
                          : item.deadlineStatus === "ON_TRACK"
                          ? "ON TRACK"
                          : "—"}
                      </td>
                      <td class="pf-rm-overdue">
                        {item.overdueTasks > 0
                          ? (
      ...
      {data.insights && data.insights.length > 0 && (
        <div class="pf-section">
          <h3 class="pf-section-title">
            <Icon name="insights" size={18} /> Portfolio Insights
          </h3>
          <div class="pf-insights-grid">
            {data.insights.map((i, idx) => (
              <div
                key={idx}
                class="pf-insight-card"
                style={`--pf-insight-border:${
                  i.type === "warning"
                    ? "#f59e0b"
                    : i.type === "info"
                    ? "#3b82f6"
