        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <div class="btn-group" style={{ display: "flex" }}>
            <button
              type="button"
              class={`btn ${
                tab === "aggregated" ? "btn-primary" : "btn-secondary"
              }`}
                ...
                {aggregates.length === 0
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <p style={{ margin: "6px 0 0" }}>
                          No API calls recorded yet. Interact with the app to
                          see metrics.
                        </p>
                      </td>
                    </tr>
                  ...
                  : aggregates.map((a) => (
                    <tr key={`${a.method} ${a.path}`}>
                      <td>
                        <span
                          class={`method-badge method-${a.method.toLowerCase()}`}
                        >
                          {a.method}
                        </span>
                      </td>
                  ...
                  : live.map((r, i) => {
                    ...
                    return (
                      <tr key={`${r.timestamp}-${i}`}>
                        ...
                        <td>
                          <span
                            class={`method-badge method-${r.method.toLowerCase()}`}
                          >
                            {r.method}
                          </span>
                        </td>
