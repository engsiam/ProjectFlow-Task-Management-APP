...
export default function InviteMemberModal({ projectId, onClose, onInvited }: { projectId: string; onClose: () => void; onInvited: () => void }) {
  ...
  return (
    <div class="modal-backdrop" role="dialog" aria-modal="true">
      <form class="modal" onSubmit={submit} style={{ maxWidth: "520px", padding: "20px" }}>
        ...
        <select class="select" value={role} onChange={(e) => setRole(e.currentTarget.value as Role)}>
