...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={(e) => submit(e)} class="auth-form-body">
      ...
      <Button variant="primary" type="submit" disabled={loading} class="auth-submit">
        {loading ? (
          <>
      ...
      <div class="auth-social-buttons">
        <button
          ...
          onClick={() => toast("Google sign-in coming soon.", "warning")}
        >
        ...
        <button
          type="button"
          class="auth-social-btn"
          onClick={() => toast("GitHub sign-in coming soon.", "warning")}
        >
          <svg width="18" height="18" viewBox="0 0 24 24">
